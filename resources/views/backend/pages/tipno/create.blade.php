                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" id="your-form-id" action="{{route('tipno-store')}}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input autocomplete="off" type="text" id="starts_at" class="form-control" name="start" value="{{ old('start') }}" required>
                                                        </div>
                                                        @error('start')
                                                        <div class="text-danger text-sm">
                                                            <small>{{ $message }}</small>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input autocomplete="off" type="text" id="expires_at" class="form-control" name="end" value="{{ old('end') }}" required>
