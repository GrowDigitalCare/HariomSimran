        ...
        <div class="page-heading">
                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">EbookCategory Table</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <section class="section">
                <div class="card">
                    ...
                    <div class="">
                        <a href="{{ route('ebookcategory-create') }}" class="btn btn-success"
                            style="float: right; margin-top: -51px; margin-right: 41px;">Add EbookCategory</a>
                    ...
                    <div class="card-body" style="overflow-x: auto;">
                        <div class="table-responsive" style="max-height: 400px;">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    @foreach ($ebookcategory as $ebookcategory)
                                        <tr>
                                          
                                            <td>{{ $ebookcategory->title }}</td>

                                            <td>{{ $ebookcategory->description }}</td>
                                        
                                            <td><img style="height:50px; width:50px;"
                                                    src="{{ asset('/uploads/ebookcategory/' . $ebookcategory->image) }}"
                                                    alt=""></td>
                                            <td>
                                                <div style="display: flex; align-items: center;">
                                                    <a href="{{ route('ebookcategory-delete', ['id' => $ebookcategory->id]) }}"
                                                        onclick="confirmation(event)" style="margin-right: 10px;"><i
                                                            class="bi bi-trash" style="color: red;font-size:20px"></i></a>
                                                    <a href="{{ route('ebookcategory-edit', ['id' => $ebookcategory->id]) }}"><i
